...
public class Doctor_Chat_Display extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        reference_patient = FirebaseDatabase.getInstance("https://diseasepredict-fbe30-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Patient_Details");
