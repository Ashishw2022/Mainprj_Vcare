...
public class Patient_UserAdapter extends RecyclerView.Adapter<Patient_UserAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull Patient_UserAdapter.ViewHolder holder, int position) {
        ...
        String url = "";
        DatabaseReference reference = FirebaseDatabase.getInstance("https://diseasepredict-fbe30-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Doctors_Data").child(email).child("doc_pic");
