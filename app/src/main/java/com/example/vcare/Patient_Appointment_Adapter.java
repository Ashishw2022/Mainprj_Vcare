...
public class Patient_Appointment_Adapter extends RecyclerView.Adapter<Patient_Appointment_Adapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance("https://diseasepredict-fbe30-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Doctors_Data");
