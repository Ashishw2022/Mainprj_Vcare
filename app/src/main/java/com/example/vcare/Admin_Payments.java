    ...
    public void getTabs()
    {
        ...
        new Handler().post(new Runnable() {
            ...
            public void run() {
                ...
                fragmentPagerAdapter.addFragment(com.example.vcare.Admin_Payments_Previous.getInstance(),"Completed");
                fragmentPagerAdapter.addFragment(com.example.vcare.Admin_Payments_Current.getInstance(),"Upcoming");
