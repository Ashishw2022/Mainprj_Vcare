...
public class Patient_Chat_Display extends AppCompatActivity {
    ...
    private void readChats() {
        ...
        reference = FirebaseDatabase.getInstance("https://diseasepredict-fbe30-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Users");
    ...
    private void status(String status){
        reference = FirebaseDatabase.getInstance("https://diseasepredict-fbe30-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Patient_Details").child(phone);
