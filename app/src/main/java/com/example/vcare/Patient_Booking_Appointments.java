...
public class Patient_Booking_Appointments extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        reference_doctor_appt = FirebaseDatabase.getInstance("https://diseasepredict-fbe30-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Doctors_Appointments");
        dates = new ArrayList<>();
        ...
        book_app.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Booking_Appointments booking_appointments = new Booking_Appointments(1, email);
                String slot_val="";
                ...
                Booking_Appointments booking = new Booking_Appointments(1, email);
